...
class _EditScreenState extends State<EditScreen> {
  ...
  void initState() {
    super.initState();
    _alamat = widget.data['tempat'];
    // _image = File(widget.data['gambar']);
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                TextFieldWidget(
                  textcontroller: widget.data['nama'] == null
                      ? _namaController
                      : _namaController
                ...
                TextFieldWidget(
                  textcontroller: widget.data['jenis'] == null
                      ? _jenisController
                      : _jenisController
                    ..text = widget.data['jenis'],
                ...
                TextFieldWidget(
                  textcontroller: widget.data['harga'] == null
                      ? _hargaController
                      : _hargaController
